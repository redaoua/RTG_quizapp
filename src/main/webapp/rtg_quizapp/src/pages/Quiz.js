...
const Quiz = () => {
  ...
  const getQuestions = async () => {
    await axios
      .get("http://localhost:8080/api/questions/random")
      .then((response) => {
        ...
        >
          <CardContent>
            ...
            <FormControl component="fieldset">
              ...
              >
                <FormControlLabel
                  value={question.prop1}
                  control={<Radio />}
                  label={question.prop1}
                />
                <FormControlLabel
                  value={question.prop2}
                  control={<Radio />}
                  label={question.prop2}
                />
                <FormControlLabel
                  value={question.prop3}
                  control={<Radio />}
                  label={question.prop3}
                />
                <FormControlLabel
                  value={question.prop4}
                  control={<Radio />}
                  label={question.prop4}
                />
              </RadioGroup>
            </FormControl>
            <Button
